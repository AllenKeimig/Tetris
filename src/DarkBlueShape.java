...
public class DarkBlueShape extends Shape{
	public DarkBlueShape(){
		...
		potentialShapeTwo[2][0] = 0;
		potentialShapeTwo[2][1] = 0;
		potentialShapeTwo[2][2] = 1;
		potentialShapeThree = new int[4][4];
		potentialShapeThree [0][0] = 0;
